# -*- coding: utf-8 -*-
"""Analysing the S&P500 Index.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1hLoJENRA8JLoBQu6WghIjMQntHUaiUsV
...
for i in tickers:
    ...
    try:
        ...
        stock_data.append({
            ...
            "Net Profit Margin (TTM)": financial_ratios[0]['netProfitMarginTTM'],
...
print(f"The S&P500 Index Dividend Yield of this year is at {round(DY_avg, 2):.2f}%.")
